...
<div class="form-group">
    <div class="alert alert-info" style="font-size: 14px">
        <i class="fa fa-user"></i> Datos del usuario: <strong>${usuario.nombre} ${usuario.apellido}</strong>
    </div>
</div>
                            ...
                            <div class="row">
                                <span class="grupo">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <input name="accsFechaInicial" id='datetimepicker1' type='text' class="form-control required"/>
                                    </div>
                                </span>
                                ...
                                <span class="grupo">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        %{--                                                            class="datepicker form-control required" daysOfWeekDisabled="0,6"/>--}%
                                        <input name="accsFechaFinal" id='datetimepicker2' type='text' class="form-control required"/>
                                    </div>
                                </span>
