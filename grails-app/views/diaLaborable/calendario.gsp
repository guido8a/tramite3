...
<div class="btn-toolbar toolbar">
    ...
    <div class="btn-group">
        ...
        <a href="#" class="btn btn-warning" id="btnDesactivar">
...
<div class="well well-sm">
    <ul>
        ...
        <li>
            Los días marcados con <div class="demo cambiado">&nbsp;</div> tienen una <strong>hora de inicio o de fin de jornada modificada</strong>.
        (Puede cambiar estos valores de manera individual para cada día haciendo <strong>click derecho</strong>).<br/>
        </li>
        <li>
